    ...
    return (
        <Container>
            <div className="container flex flex-column">
                ...
                <div className="cards w-12 flex flex-column gap-4 align-items-center">
                    <Card className='card w-10 flex align-items-center'>
                        <div className="flex align-items-start p-2 ml-5 gap-6">
                            <img alt='card' src='https://assets.pagseguro.com.br/ps-cart-assets/1.46.0/legacy/app/public/assets/images/products/768/d0211debd8a96744.png'/>
                            ...
                            <div className="info ml-5 -mt-1 text-xs">
                            ...
                            <div className="pagamento text-xs">
                    ...
                    <Card className='card w-10 flex align-items-center xl:p-3'>
                        <div className="img flex align-items-start ml-7 gap-6">
                            ...
                            <div className="info -mt-1 text-base">
                            ...
                            <div className="quantidade -ml-3 -mt-1">
                    ...
                    <Card className='card w-10 flex align-items-center'>
                        <div className="img flex align-items-start p-2 ml-7 gap-6">
                            <img className='-ml-6' alt='card' src='https://assets.pagseguro.com.br/ps-cart-assets/1.46.0/legacy/app/public/assets/images/visa-card-80x54.png'/>
                            <div className='text-base'>
                                <h1 className='text-base line-height-3 -ml-5 font-medium'>Cartão Internacional da Conta PagBank GRÁTIS</h1>
                            </div>
                            <div className="info line-height-2 font-base">
                            ...
                            <div className=" -mt-1 -ml-7">
                                ...
                                <div className='ml-8'>
                                    <p className='text-sm'><span className='font-medium'>Importante:</span> esse cartão não tem limite de crédito, só funciona se você tiver saldo na conta.</p>
                                </div>
                            </div>
                        </div>
                    </Card>
                ...
                <div className='cart-footer flex justify-content-center w-full gap-4'>
                    <div className='w-5'>
                        <Card className='card w-full mt-4 flex-wrap flex'>
                            <div className="img h-3rem flex -mt-5 gap-2 align-items-center border-bottom-1 border">
                                <img alt='card' src='https://assets.pagseguro.com.br/ps-cart-assets/1.46.0/legacy/app/public/assets/images/pix/PIX2.svg'/>
                                <span className='text-sm'>Prepare-se para receber pelo QR Code Pix na maquininha</span>
                            </div>
                    ...
                    <div className='pagamento flex flex-column mt-4 p-4 w-5 h-28rem bg-bluegray-100'>
                        <div className='h-7rem flex flex-column border-bottom-1'>
                            ...
                            <div className='flex justify-content-end mt-3'>
                                <Button className='flex' size='large' label='Continuar' severity='Continuar'/>
                            </div>
